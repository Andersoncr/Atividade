...
package ribeiro.anderson.atividade.util;
...
public class Utils {
    ...
    private static ribeiro.anderson.atividade.util.StatusTracker mStatusTracker = ribeiro.anderson.atividade.util.StatusTracker.getInstance();
